...
export function render(address, index) {
  ...
  shadow.innerHTML = `
    <style>
      ...
      .threat-badge { position: absolute; top: 32px; right: 32px; background: #000; border: 1px solid rgba(168, 85, 247, 0.3); border-radius: 100px; padding: 4px 12px; display: flex; items: center; gap: 6px; }
      ...
      .btn-p { background: #0a0a0a; border: 1px solid rgba(168, 85, 247, 0.3); color: var(--accent); margin-bottom: 12px; }
      .btn-s { background: transparent; border: 1px solid #1a1a1a; color: #555; }
      .hp { position: absolute; left: 0; top: 0; bottom: 0; background: rgba(168, 85, 247, 0.1); width: 0%; transition: width 0.05s linear; pointer-events: none; }
      ...
      <div class="card">
        ...
        <div class="logic-section">
          ...
          <div class="block">
            ...
            <p class="logic-text">"Interception triggered by high-risk source contexts such as social DMs or unverified dApp portals."</p>
          </div>
          <div class="block">
            <div class="lbl-pill lbl-ex">Example</div>
            <p class="logic-text">"You copy a 'Treasury Address' from a Telegram DM or a random X (Twitter) comment."</p>
          </div>
        </div>
        <div class="telemetry">
        ...
        <button class="btn btn-s" id="o"><div class="hp" id="hp"></div><span>IGNORE SHIELD: TRUST MANUALLY [HOLD 1.5S]</span></button>
