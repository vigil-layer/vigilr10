...
export function render(address, index) {
  ...
  shadow.innerHTML = `
    <style>
      ...
      .threat-badge { position: absolute; top: 32px; right: 32px; background: #000; border: 1px solid rgba(234, 179, 8, 0.3); border-radius: 100px; padding: 4px 12px; display: flex; items: center; gap: 6px; }
      ...
      .btn-p { background: #0a0a0a; border: 1px solid rgba(234, 179, 8, 0.3); color: var(--accent); margin-bottom: 12px; }
      .btn-s { background: transparent; border: 1px solid #1a1a1a; color: #555; }
      .hp { position: absolute; left: 0; top: 0; bottom: 0; background: rgba(234, 179, 8, 0.1); width: 0%; transition: width 0.05s linear; pointer-events: none; }
      ...
      <div class="card">
        ...
        <div class="header">
          ...
          <div class="header-text">
            <h3>Report: Similarity Notice</h3>
        ...
        <div class="logic-section">
          ...
          <div class="block">
            ...
            <p class="logic-text">"Analysis of non-random character clusters that signal a computationally generated vanity attack."</p>
          </div>
          <div class="block">
            <div class="lbl-pill lbl-ex">Example</div>
            <p class="logic-text">"VIGIL detects that an address has been mathematically forced to start with 'DEFI...' or 'CEX...'."</p>
          </div>
        </div>
        <div class="telemetry">
        ...
        <button class="btn btn-s" id="o"><div class="hp" id="hp"></div><span>INTENT MATCHES: CONTINUE [HOLD 1.5S]</span></button>
