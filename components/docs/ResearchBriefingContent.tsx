...
// External Reference Links - Verified for Institutional Credibility
const LINKS = {
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
           ...
           <div className="lg:col-span-5">
              <DocCard border="zinc">
                 <div className="space-y-6">
                    <h4 className="text-xs font-black text-zinc-400 uppercase tracking-[0.3em]">Institutional Directive</h4>
